  ...
  return (
    <header className="bg-white dark:bg-slate-800/50 shadow-sm sticky top-0 z-10 backdrop-blur-md">
      <div className="container mx-auto px-4 md:px-8 py-4 flex items-center gap-4">
        ...
        <div>
           <h1 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-slate-100">Resume Relevance Engine</h1>
           <p className="text-sm text-slate-500 dark:text-slate-400">AI-Powered Resume vs. Job Description Analysis</p>
        </div>
      </div>
    </header>
  );
